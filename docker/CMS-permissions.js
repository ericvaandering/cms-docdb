...
function CmsTransformPermissions(){
    ...
    // updated version of permissions and author handling without td
    //if (jQuery.getUrlVar('test') =='test'){
		view_td = jQuery("#ViewPermissions").first();
		modify_td = jQuery("#ModifyPermissions").first();
	//}
