...
$Preferences{Components}{AgendaMaker}      = $FALSE; # Sessions for events
$Preferences{Components}{Calendar}         = $FALSE; # Calendar
$Preferences{Components}{LastModifiedHome} = $FALSE; # Last modified on the homepage
...
# Remember to add to /etc/httpd/conf.d/docdb.conf if needed (new groups not part of others)
%ShibGroupMap = ( "cms-docdb" => ["CMS"],
#                  "cms-web-access"    => ["CMS"],
                  "cms-docdbadm"  => ["CMSDocAdmin", "CMS", "Secretariat", "ComputingMngt", "Physics"],
                  "cms-cms-secretariat" => ["Secretariat"],
                  "cms-mgt-computing" => ["ComputingMngt"],
                  "cms-physics-access" => ["Physics"],
                  "cms-up-mgmt" => ["CMS-UP-MGMT"],
                  "uscms-snc-mgmt" => ["USCMS-SNC-MGMT"],
                  "cms-exec-mgmt" => ["CMS Exec Mgmt"],
                  "cms-spokesperson-and-deputies" => ["CMS Spokesperson"],
                  "mtd-steering-group" => ["MTD-XSC"],
                  "uscms" => ["USCMS"],
                  "uscms-mgmt" => ["USCMS-MGMT"],
                  "uscms-up-reviews" => ["USCMS-UP-REVIEWS"],
                  "uscms-hlup-reviewers" => ["USCMS-UP-REVIEWS"],
#                  "uscms-up-evms-2014" => ["USCMS-UP-REVIEWS"],
                  "uscms-up-team" => ["USCMS-UP-TEAM"],
                  "uscms-up-phase2" => ["USCMS-UP-PHASE2"],
);
...
# URL to the public DocDB
$Preferences{Security}{Instances}{Public}  = "https://cms-docdb.cern.ch/cgi-bin/PublicDocDB/";
$Preferences{Security}{AutoCreateShib} = $TRUE;  # Automatically create a Shibboleth user if none exists
$Preferences{Options}{Update}{RequireSubmitter} = $TRUE;
...
$WelcomeMessage = 'Welcome to CMS DocDB at CERN. Access is by CERN Single-Signon. '.
'Details for transitioning and first time users are '.
'<a href="https://twiki.cern.ch/twiki/bin/viewauth/CMS/DocDB">here</a>.';
